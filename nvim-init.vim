...
" Plugins {
    ...
    " General Programming {
        ...
        let g:SuperTabMappingTabLiteral = '<c-k>'
    " }
...
" Formatting {
    ...
    autocmd FileType c,cpp setlocal tabstop=4 shiftwidth=4 expandtab softtabstop=4
    autocmd FileType python setlocal tabstop=4 shiftwidth=4 expandtab tabstop=8 colorcolumn=80
    autocmd FileType json,proto,html,css,javascript setlocal tabstop=2 shiftwidth=2 expandtab softtabstop=2
